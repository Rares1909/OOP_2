		...
		case 1:
			...
			if (alegere == "Da" or alegere=="da") {
				...
				for (i = 0; i < apartamente.size() - 1; i++)
					if (apartamente[i].get_suprafata_utila() > apartamente[i + 1].get_suprafata_utila())
						ideal_apartament = apartamente[i + 1];
			}
				...
				cin >> teren;
					...
					if (alegere == "Da" or alegere=="da") {
						...
						for (i = 0; i < casa.size() - 1; i++)
							if (casa[i].get_suprafata_utila() > casa[i + 1].get_suprafata_utila())
								ideal_casa = casa[i + 1];
					}
